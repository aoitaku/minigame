...
class Pin
  ...
  def draw
    Window.draw_line(
      body_a.p.x + anchor_a.x,
      body_a.p.y + anchor_a.y,
      body_b.p.x + anchor_b.x,
      body_b.p.y + anchor_b.y, C_YELLOW)
  end

end

wall2 = CPBox.new(110, 150, 100, 10, 1)
wall2.shape.e = 0 # 弾性(0.0～1.0)
wall2.shape.u = 0 # 摩擦(0.0～1.0)
wall2.shape.collision_type = :mover

circle = CPCircle.new(80, 0, 80, 1)
